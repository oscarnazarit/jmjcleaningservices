  ...
  return (
    <header className="flex w-full justify-center px-4 py-4">
      <NavigationMenu className="w-full max-w-5xl">
        <div className="flex w-full items-center justify-between gap-6 md:justify-center md:gap-6">
        ...
        {!isMobile && (
          <LanguageSelector className="min-w-35.7 px-2 py-1.5" selectClassName="text-xs" />
        )}
      </NavigationMenu>
    </header>
  );
